...
st.download_button("📥 Scarica risultato in CSV", data=csv_buffer.getvalue(), file_name="risultato_ai4ecopack.csv", mime="text/csv"), file_name="risultato_ai4ecopack.csv", mime="text/csv"))
