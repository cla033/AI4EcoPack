...
# CO₂ associato a ciascun packaging
co2_packaging = {
    "Cartone riciclato": 100,
    "Plastica riciclata": 250,
    "Bioplastica": 80,
    "Polistirolo": 400,
    "Legno": 150
}
...
if st.session_state.get("prediction_done", False):
    ...
    # Salvataggio grafico come immagine e inserimento nel PDF
    emissioni_totali = {
    ...
    plt.tight_layout()
    img_path = "/tmp/grafico_inquinamento.png"
...
st.markdown(
    ...
    <div class="footer-container">
        <div class="footer-left">© Protetto da copyright</div>
        <div class="footer-right">BETA</div>
    </div>
    ''',
    unsafe_allow_html=True
)
...
# Grafico delle emissioni totali per tipo di packaging
st.write("### 📊 Inquinamento totale stimato per tipo di packaging")
emissioni_totali = {
    "Cartone riciclato": 1200,
    "Plastica riciclata": 2500,
    "Bioplastica": 900,
...
st.markdown(
    ...
    <div class="footer-container">
        <div class="footer-left">© AI4EcoPack 2025 - All rights reserved</div>
        <div class="footer-right">BETA</div>
    </div>
    ''',
    unsafe_allow_html=True
