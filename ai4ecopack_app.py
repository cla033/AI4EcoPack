...
def train_model(df):
    ...
    if len(X_train) < 5:
        raise ValueError("Dataset too small for Grid Search. Please provide a larger dataset.")
...
if uploaded_file is not None:
    ...
    if st.button('Predict Packaging for Dataset'):
        ...
        impact_factors = {'Cartone S': 0.5, 'Plastica M': 1.0, 'Cartone L': 1.5, 'Plastica S': 0.7}
